...
const Login = () => {
  ...
  return (
    ...
    <div className="absolute">
     ...
     <form onSubmit={(e)=>e.preventDefault()} className="w-full md:w-3/12 absolute p-4  px-8 bg-black my-28 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-80">
